 ...
 *
 * The [Game] class serves as the root element of the entity layer and stores all relevant
 * game data, including players, card stacks, the current player index, round tracking,
 * and the game log.
 *
 * It does not contain complex game logic. All state modifications beyond simple data updates
 * must be performed via the service layer.
 *
 ...
 * @property drawStack The stack of cards from which new cards are drawn.
